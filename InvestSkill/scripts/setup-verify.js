  ...
  if (result.found) {
    ...
    try {
      ...
      if (output.includes('us-stock-analysis') || output.includes('InvestSkill')) {
        ...
        console.log('   ℹ️  InvestSkill plugin not found');
    ...
    console.log('   ℹ️  Claude Code CLI not installed (optional)');
...
function main() {
  try {
    ...
    console.log('   - Gemini Guide:  GEMINI.md');
    console.log('   - Claude Guide:  CLAUDE.md');
    console.log('\n');
