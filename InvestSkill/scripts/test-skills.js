...
// ─── Test 9: Key Documentation Files ───────────────────────────────────────

section('9. Required Documentation Files');
...
if (countDrift === 0) pass(`All docs advertise ${ADVERTISED} frameworks`);

// ─── Test 11: bear-case Skill Contract ──────────────────────────────────────

section('11. bear-case Skill Contract (intentional one-sided design)');
...
// ─── Test 12: Cross-AI Config Completeness & Count Consistency ───────────────

section('12. Cross-AI Config Completeness & Count Consistency');
...
// Every prompt file must be referenced in each cross-AI config
